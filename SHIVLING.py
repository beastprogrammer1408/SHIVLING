...
turtle.title('SHIVLING Design BY- SHREYAS PRALHAD JOSHI')
turtle.speed(0)
turtle.up()
turtle.hideturtle()
...
my_goto(-300, -300)
turtle.write('BY :- SHREYAS PRALHAD JOSHI', font=("Bradley Hand ITC", 50, "bold"))  


my_goto(-150,150)
turtle.write('HAR HAR MAHADEV', font=("Bradley Hand ITC", 50, "bold"))  
turtle.done()
